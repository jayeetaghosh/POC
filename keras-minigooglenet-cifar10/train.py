...
# USAGE
# python train.py --output single_gpu.png --batchsize 128
# python train.py --output multi_gpu.png --gpus 4 --batchsize 128
...
H = model.fit_generator(
	aug.flow(trainX, trainY, batch_size=batchsize * G),
	validation_data=(testX, testY),
	steps_per_epoch=len(trainX) // (batchsize * G),
	epochs=NUM_EPOCHS,
