...
# Lets save into files
# np.savetxt("seq_array.csv", seq_array, delimiter=",")

# Write the array to disk
with open('seq_array.csv', 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
    outfile.write('# Array shape: {0}\n'.format(seq_array.shape))

    # Iterating through a ndimensional array produces slices along
    # the last axis. This is equivalent to data[i,:,:] in this case
    i = 0
    for data_slice in seq_array:
...
print("number of data_slice", i, data_slice)

train_df.to_csv("train_df.csv", sep='\t', encoding='utf-8')
...
# fit the network
history = model.fit(seq_array, label_array, epochs=3, batch_size=200, validation_split=0.2, verbose=1,
...
plt.legend()
# save the figure
plt.savefig("../../Output/model_loss_accuracy.png")
plt.close()
